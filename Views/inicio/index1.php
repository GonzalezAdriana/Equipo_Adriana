<h1 align="center" >Inicio de Control de la Pluma</h1>
    ...
    <div class="login-form">
        <div class="main-div">
            ...
            <form id="registro" class="form-singin" action="<?php echo URL ?>login/guardar" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div>
                    <input type="password" class="form-control" id=pass placeholder="Constraseña" value="">
                </div>
                ...
                <br>
                <div class="container">
                    <a id="registrar" type="submit" class="btn btn-primary"  >Completar registro</a>
                </div>
        </div>
        </form>
    </div>
