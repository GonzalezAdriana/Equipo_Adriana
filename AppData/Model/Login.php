...
class Login {
    ...
    public function verify() {
        $sql="SELECT u.id_usuario, p.nombre, p.ap_p, p.ap_m, u.id_tipo_usuario FROM persona p, usuario u, sexo s, tipo_usuario tu 
where u.nickname='{$this->usuario}' and u.password='{$this->contraseña}' and p.id_usuario=u.id_usuario and u.id_tipo_usuario=tu.id_tipo_usuario
 and p.id_sexo=s.id_sexo";
    ...
    public function guardar() {
        $sql="INSERT INTO usuarios (nickname, password, id_tipo_usuario) VALUES ('{$this->nickname}','{$this->contraseña}','{$this->id_tipo_usuario}')";
